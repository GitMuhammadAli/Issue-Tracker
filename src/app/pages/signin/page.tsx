      ...
      <Card className="w-full max-w-md shadow-lg">
        <form onSubmit={handleSubmit}>
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center text-[#3F72AF]">Enter your credentials to access TrackPro</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="relative">
                <Mail className="absolute left-3 top-3 h-5 w-5 text-[#3F72AF]" />
                <Input id="email" type="email" placeholder="Email" className="pl-10 bg-[#F9F7F7] border-[#3F72AF] focus:border-[#112D4E]" onChange={handleChange} />
              </div>
            </div>
            <div className="space-y-2">
              <div className="relative">
                <Lock className="absolute left-3 top-3 h-5 w-5 text-[#3F72AF]" />
                <Input id="password" type="password" placeholder="Password" className="pl-10 bg-[#F9F7F7] border-[#3F72AF] focus:border-[#112D4E]" onChange={handleChange} />
              </div>
            </div>
